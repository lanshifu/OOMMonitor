...
public class ShadowThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public ShadowThreadPoolExecutor(
        ...
        super(fixCorePoolSize(corePoolSize), fixMaximumPoolSize(maximumPoolSize), keepAliveTime, unit, workQueue, new NamedThreadFactory(prefix));
        print(corePoolSize, maximumPoolSize, keepAliveTime, optimize);
        if (optimize) {
    ...
    public ShadowThreadPoolExecutor(
        ...
        super(fixCorePoolSize(corePoolSize), fixMaximumPoolSize(maximumPoolSize), keepAliveTime, unit, workQueue, new NamedThreadFactory(threadFactory, prefix));
        print(corePoolSize, maximumPoolSize, keepAliveTime, optimize);
        if (optimize) {
            allowCoreThreadTimeOut(getKeepAliveTime(unit) > 0);
        }
    ...
    public ShadowThreadPoolExecutor(
        ...
        super(fixCorePoolSize(corePoolSize), fixMaximumPoolSize(maximumPoolSize), keepAliveTime, unit, workQueue, new NamedThreadFactory(prefix), handler);
        print(corePoolSize, maximumPoolSize, keepAliveTime, optimize);
        if (optimize) {
            allowCoreThreadTimeOut(getKeepAliveTime(TimeUnit.SECONDS) > 0);
        }
    }
    ...
    public ShadowThreadPoolExecutor(
        ...
        super(fixCorePoolSize(corePoolSize), fixMaximumPoolSize(maximumPoolSize), 10, unit, workQueue, new NamedThreadFactory(threadFactory, prefix), handler);
        print(corePoolSize, maximumPoolSize, keepAliveTime, optimize);
        if (optimize) {
            allowCoreThreadTimeOut(getKeepAliveTime(TimeUnit.SECONDS) > 0);
        }
    ...
    private void print(int corePoolSize, int maximumPoolSize, long keepAliveTime, boolean optimize) {
        Log.i("lxb", "ShadowThreadPoolExecutor: corePoolSize=" + corePoolSize + ",maximumPoolSize=" + maximumPoolSize + ",keepAliveTime=" + keepAliveTime + ",optimize=" + optimize);
        Log.d("lxb", "ShadowThreadPoolExecutor:" + Log.getStackTraceString(new Throwable()));
    }

    private static int fixCorePoolSize(int corePoolSize){
        return corePoolSize;
    }
    private static int fixMaximumPoolSize(int maximumPoolSize){
